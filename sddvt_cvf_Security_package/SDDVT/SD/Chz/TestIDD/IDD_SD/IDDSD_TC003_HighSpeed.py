...
# SCRIPTER SCRIPT                : IDDSD_TC003_HighSpeed.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : IDDSD_TC003_HighSpeed.py
# DESCRIPTION                    : For IDD Test in HighSpeed Mode
# PRERQUISTE                     : IDDSD_UT004_InitCard, IDDSD_UT001_InitCardSimple, IDDSD_UT003_InitCard_UHS_SD3_0,
#                                  IDDSD_UT002_PreSleepExec_UHS_SD3_0, IDDSD_UT005_PreSleepExec
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=IDDSD_TC003_HighSpeed --isModel=false --enable_console_log=1 --adapter=0
...
class IDDSD_TC003_HighSpeed(customize_log):
    ...
    def GetInitConfigValues(self):
        ...
        self.cfgfile = os.path.join(self.__TestsDir,'SDDVT', 'SD', 'Chz', 'TestIDD','Configurations_Master', "Master_Configuration_IDD_SD_HighSpeed.txt")
    ...
    def Run(self):
        ...
        directory = os.path.join(FW_VALIDATION_PATH,'SDDVT', 'SD', 'Chz', 'TestIDD' , 'IDD_SD' ,'Measurements', 'HS')
        ...
        while (loopsHost != 0) and (vddhRepresentation != 0xFF):
            ...
            if globalParameters["IDD_MeasureVddf"] == 1:
                ...
                while (loopsFlash != 0) and (vddfRepresentation  != 0xFF):
                    ...
                    self.__InitCard.Run(globalParameters) # Utility UT004
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_IDDSD_TC003_HighSpeed(self):
        obj = IDDSD_TC003_HighSpeed(self.vtfContainer)
        obj.Run()
