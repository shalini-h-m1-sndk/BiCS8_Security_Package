...
# SCRIPTER SCRIPT                : IDDSD_UT002_PreSleepExec_UHS_SD3_0.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : IDDSD_UT002_PreSleepExec_UHS_SD3_0.py
# DESCRIPTION                    : Presleep mode for UHS intilized card.
# PRERQUISTE                     : IDDSD_UT003_InitCard_UHS_SD3_0.py
...
import IDDSD_UT003_InitCard_UHS_SD3_0 as InitCard_UHS_SD3_0
...
class IDDSD_UT002_PreSleepExec_UHS_SD3_0(customize_log):
    def __init__(self, VTFContainer):
        ...
        self.__IDD_InitCard_UHS_SD3_0 = InitCard_UHS_SD3_0.IDDSD_UT003_InitCard_UHS_SD3_0(self.vtfContainer)
    ...
    def Run(self,globalParameters=None):
        ...
        """
        For presleep mode in UHS mode
        """

        IDD_PreSleepExe =  int(globalParameters["IDD_PreSleepExe"])

        if IDD_PreSleepExe == 0: #Reset
            self.__IDD_InitCard_UHS_SD3_0.Run(globalParameters)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_IDDSD_UT002_PreSleepExec_UHS_SD3_0(self):
        obj = IDDSD_UT002_PreSleepExec_UHS_SD3_0(self.vtfContainer)
        obj.Run()
