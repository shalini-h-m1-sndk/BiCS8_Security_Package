...
# SCRIPTER SCRIPT                : IDDSD_TC001_UHS_WithNewFPGASDR104.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : IDDSD_TC001_UHS_WithNewFPGASDR104.py
# DESCRIPTION                    : For IDD Test in SDR104 Mode
# PRERQUISTE                     : IDDSD_UT004_InitCard, IDDSD_UT001_InitCardSimple, IDDSD_UT003_InitCard_UHS_SD3_0, IDDSD_UT002_PreSleepExec_UHS_SD3_0
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=IDDSD_TC001_UHS_WithNewFPGASDR104 --isModel=false --enable_console_log=1 --adapter=0
...
import IDDSD_UT003_InitCard_UHS_SD3_0 as InitCardUHS_3_0
import IDDSD_UT002_PreSleepExec_UHS_SD3_0 as PreSleepExec_UHS_SD3_0
...
class IDDSD_TC001_UHS_WithNewFPGASDR104(customize_log):
    def __init__(self, VTFContainer):
        ...
        self.__InitCard_UHS_SD3_0 = InitCardUHS_3_0.IDDSD_UT003_InitCard_UHS_SD3_0(self.vtfContainer)
        self.__PreSleepExec_UHS_SD3_0 = PreSleepExec_UHS_SD3_0.IDDSD_UT002_PreSleepExec_UHS_SD3_0(self.vtfContainer)

        self.__sdVoltage           = sdcmdWrap.SVoltage()
        self.__globalParameters    = {} #global file values
        self.__dirPath             = None
    ...
    def GetInitConfigValues(self):
        ...
        self.cfgfile = os.path.join(self.__TestsDir,'SDDVT', 'SD', 'Chz', 'TestIDD','Configurations_Master', "Master_Configuration_IDD_SD_SDR104.txt")
    ...
    def Run(self):
        ...
        if self.currCfg.variation.sdconfiguration != "SDR104" : #for 104 config
        ...
        # Below variables are not used anywhere in the script. So commenting below variable declariations
        #SendCmd11_in_Init = 1 # enable = 1, disable = 0
        #XPC_enable = 1 # enable = 1, disable = 0
        ...
        directory = os.path.join(FW_VALIDATION_PATH, 'SDDVT','SD', 'Chz', 'TestIDD' , 'IDD_SD' ,'Measurements','SDR104')
        ...
        vddh = vddhRepresentation * 50 # 2700 value in scripter
        ...
        while (loopsHost != 0) and (vddhRepresentation != 0xFF):
            ...
            if globalParameters["IDD_MeasureVddf"] == 1:
                self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "###  -----------------   VDDF STARTED   --------------")
                ...
                while (loopsFlash != 0) and (vddfRepresentation  != 0xFF):
                    ...
                    self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "************  VDDF SECTION STARTED*****************\n")
                    self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "#"*150)
                    ...
                    self.__InitCard_UHS_SD3_0.Run(globalParameters)
                    ...
                    self.__PreSleepExec_UHS_SD3_0.Run(globalParameters)
                ...
                self.iddMesureInSleepMode_HotInsertionMode() #Measure IDD in  Hot insertion
    ...
    def WriteGeneralResultsFile(self,filename):
        ...
        """
        self.fatalLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Started to write to results file\n")
        fp = open(filename,"w")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_IDDSD_TC001_UHS_WithNewFPGASDR104(self):
        obj = IDDSD_TC001_UHS_WithNewFPGASDR104(self.vtfContainer)
        obj.Run()
