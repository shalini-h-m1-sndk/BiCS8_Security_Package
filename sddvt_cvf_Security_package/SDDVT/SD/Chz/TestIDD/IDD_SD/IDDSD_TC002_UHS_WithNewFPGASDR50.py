...
# SCRIPTER SCRIPT                : IDDSD_TC002_UHS_WithNewFPGASDR50.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : IDDSD_TC002_UHS_WithNewFPGASDR50.py
# DESCRIPTION                    : For IDD Test in SDR50 Mode
...
# TEST ARGUMENTS                 : --test=IDDSD_TC002_UHS_WithNewFPGASDR50 --isModel=false --enable_console_log=1 --adapter=0
...
class IDDSD_TC002_UHS_WithNewFPGASDR50(customize_log):
    ...
    def Run(self):
        ...
        directory = os.path.join(FW_VALIDATION_PATH, 'SDDVT','SD', 'Chz', 'TestIDD' , 'IDD_SD' ,'Measurements', 'SDR50')
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_IDDSD_TC002_UHS_WithNewFPGASDR50(self):
        obj = IDDSD_TC002_UHS_WithNewFPGASDR50(self.vtfContainer)
        obj.Run()
