...
# SCRIPTER SCRIPT                : PQT_TC03_Stage2_WriteReadQuarter.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : PQT_TC03_Stage2_WriteReadQuarter.py
# DESCRIPTION                    : For issuing Power Cycle.
# PRERQUISTE                     : PQT_UT01_Common_Init.py, PQT_UT02_HighSpeed_Init.py, PQT_UT03_UHS_Init.py, PQT_TC04_READ.py, PQT_TC05_WRITE.py
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=PQT_TC03_Stage2_WriteReadQuarter --isModel=false --enable_console_log=1 --adapter=0
...
import PQT_TC05_WRITE as WRITE
...
class PQT_TC03_Stage2_WriteReadQuarter(customize_log):
    def __init__(self, VTFContainer):
        ...
        self.__WRITE =  WRITE.PQT_TC05_WRITE(self.vtfContainer)
    ...
    def Run(self,globalParameters=None):
        ...
        #write
        globalParameters =  self.__WRITE.Run(globalParameters)

        globalParameters["StartRead"] = int(globalParameters["WrittenSize"]) + int(globalParameters["StartValidationAt"])
        globalParameters["ReadSize"] = int(globalParameters["ReadSize_Const"]) - int(globalParameters["StartRead"])
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_PQT_TC03_Stage2_WriteReadQuarter(self):
        obj = PQT_TC03_Stage2_WriteReadQuarter(self.vtfContainer)
        obj.Run()
