...
# SCRIPTER SCRIPT                : PQT_UT02_HighSpeed_Init.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : PQT_UT02_HighSpeed_Init.py
# DESCRIPTION                    : For default Intilization in High Speed.
# PRERQUISTE                     : None
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=PQT_UT02_HighSpeed_Init --isModel=false --enable_console_log=1 --adapter=0
...
class PQT_UT02_HighSpeed_Init(customize_log):
    ...
    def Run(self,globalParameters=None):
        ...
        """
        PQT_UT02_HighSpeed_Init using pattern generator
        """

        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Card Intilization into HighSpeed\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_PQT_UT02_HighSpeed_Init(self):
        obj = PQT_UT02_HighSpeed_Init(self.vtfContainer)
        obj.Run()
