...
# CVF SCRIPT                     : CMD23_UT03_CMD20_GetSequence.py
# DESCRIPTION                    :
# PRERQUISTE                     :
...
class CMD23_UT03_CMD20_GetSequence(customize_log):
    ...
    def Run(self, ExpectSequence = 0):
        ...
        #if ExpectSequence == 0 :
            #self.__sdCmdObj.GetInSpeedClassMode()
        #elif ExpectSequence == 1:
            #self.__sdCmdObj.GetInSpeedModeClass()

        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-" * 20 + "  Utility Execution Completed " + "-" * 20 + "\n")
        return 0

    #End of Run function
#End of CMD20GetSequence
