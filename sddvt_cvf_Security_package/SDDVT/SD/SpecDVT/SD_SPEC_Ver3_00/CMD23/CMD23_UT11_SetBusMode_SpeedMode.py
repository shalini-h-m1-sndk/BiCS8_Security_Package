...
# CVF SCRIPT                     : CMD23_UT11_SetBusMode_SpeedMode.py
# DESCRIPTION                    :
# PRERQUISTE                     : [ConfigSD_UT007_GlobalSetBusMode, ConfigSD_UT013_GlobalSetSpeedMode]
...
class CMD23_UT11_SetBusMode_SpeedMode(customize_log):
