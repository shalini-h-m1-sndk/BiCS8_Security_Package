...
# CVF SCRIPT                     : CMD23_UT14_Successful_Verify_MaxVoltage.py
# DESCRIPTION                    :
# PRERQUISTE                     :
...
class CMD23_UT14_Successful_Verify_MaxVoltage(customize_log):
    ...
    def Run(self):
        ...
        # Multiple Write from start block = 0x000 with end block = 0x32000 with pattern incremental
        startlba=0x000
        blockCount = 0x32000
        self.__dvtLib.WriteWithFPGAPattern(startlba, blockCount, pattern = 2)

        # Multiple Read from start block = 0x000 with end block = 0x32000 with pattern incremental
        startlba=0x000
        blockCount = 0x32000
        self.__dvtLib.ReadWithFPGAPattern(startlba, blockCount, pattern = 2)
