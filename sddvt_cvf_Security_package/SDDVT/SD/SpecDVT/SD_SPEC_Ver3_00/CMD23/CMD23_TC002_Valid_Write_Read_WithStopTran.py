...
# CVF SCRIPT                     : CMD23_TC002_Valid_Write_Read_WithStopTran.py
# DESCRIPTION                    :
# PRERQUISTE                     : [CMD23_UT08_LoadCMD23_Variables, CMD23_UT09_LoadLocal_Variables, CMD23_UT06_CMD23Write, CMD23_UT10_Reset]
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=CMD23_TC002_Valid_Write_Read_WithStopTran --isModel=false --enable_console_log=1 --adapter=0
...
class CMD23_TC002_Valid_Write_Read_WithStopTran(TestCase.TestCase, customize_log):
    ...
    def Run(self, ret = 0):
        ...
        while LoopCounter < 100:
            ...
            if RandomStartAddress == 2:
                g_localVars["CMD23StartBlock"] = random.randrange(old_div(U,2))
            ...
            if RandomBlockCount == 1:
                g_localVars["PredefinedNumOfBlkCnt"] = random.randrange(0xFFFF) + 1
...
#End of CMD23ValidWriteReadWthStopTran
    ...
    def test_CMD23_TC002_Valid_Write_Read_WithStopTran(self):  # [Same in xml tag: <Test name="test_CMD23_TC002_Valid_Write_Read_WithStopTran">]
