...
# CVF SCRIPT                     : CMD23_UT13_Successful_Verify.py
# DESCRIPTION                    :
# PRERQUISTE                     :
...
class CMD23_UT13_Successful_Verify(customize_log):
    ...
    def Run(self):
        ...
        #Multiple Write with pattern incremental
        self.__dvtLib.WriteWithFPGAPattern(startLba, blockCount, pattern = 0)
        #Multiple Read with pattern incremental
        self.__dvtLib.ReadWithFPGAPattern(startLba, blockCount, pattern = 0)
