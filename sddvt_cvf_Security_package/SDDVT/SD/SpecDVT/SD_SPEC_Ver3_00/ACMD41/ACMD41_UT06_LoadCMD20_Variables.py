...
# SCRIPTER SCRIPT                : ACMD41_UT06_LoadCMD20_Variables.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : ACMD41_UT06_LoadCMD20_Variables.py
# DESCRIPTION                    :
# PRERQUISTE                     : ACMD41_UT01_AUSize_Calculation.py
...
import ACMD41_UT01_AUSize_Calculation as AuSizeCalculation
...
class ACMD41_UT06_LoadCMD20_Variables(customize_log):
    def __init__(self, VTFContainer):
        ...
        self.__ausize = AuSizeCalculation.ACMD41_UT01_AUSize_Calculation(self.vtfContainer)
    ...
    def Run(self):
        ...
        CMD20Variables['BitMap_size'] = 0x0
        CMD20Variables['Lba_of_first_AU'] = 0x0

        # Call GET FAT ADDRESSES
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Call API GetFatAddr() to get fat addresses ")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_ACMD41_UT06_LoadCMD20_Variables(self):
        obj = ACMD41_UT06_LoadCMD20_Variables(self.vtfContainer)
        obj.Run()
