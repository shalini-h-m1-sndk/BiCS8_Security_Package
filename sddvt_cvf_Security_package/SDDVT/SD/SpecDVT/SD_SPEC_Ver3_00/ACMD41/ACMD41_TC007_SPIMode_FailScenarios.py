...
# SCRIPTER SCRIPT                : ACMD41_TC007_SPIMode_FailScenarios.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : ACMD41_TC007_SPIMode_FailScenarios.py
# DESCRIPTION                    :
# PRERQUISTE                     : ACMD41_UT07_Load_LocalVariables.py, ACMD41_UT08_Reset.py
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=ACMD41_TC007_SPIMode_FailScenarios --isModel=false --enable_console_log=1 --adapter=0
...
class ACMD41_TC007_SPIMode_FailScenarios(customize_log):
    ...
    def Run(self):
        ...
        for CMD58Loop in range(0, 6):
            ...
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Power On ->CMD0-> CMD8->CMD58->ACMD41->Card_Is_Busy")
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "HSC=0 S18R=Y XPC=Z Successful Scenario")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_ACMD41_TC007_SPIMode_FailScenarios(self):
        obj = ACMD41_TC007_SPIMode_FailScenarios(self.vtfContainer)
        obj.Run()
