...
# SCRIPTER SCRIPT                : ACMD41_TC008_SDandSPI_CombinedScenarios.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : ACMD41_TC008_SDandSPI_CombinedScenarios.py
# DESCRIPTION                    : The purpose of this test case is to test the Ability to switch between SD and SPI modes
...
# TEST ARGUMENTS                 : --test=ACMD41_TC008_SDandSPI_CombinedScenarios --isModel=false --enable_console_log=1 --adapter=0
...
class ACMD41_TC008_SDandSPI_CombinedScenarios(customize_log):
    ...
    def Run(self):
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "CMD0 -> CMD8 -> CMD58 -> ACMD41 -> Error")
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "CMD0 -> CMD8 -> ACMD41 (XPC=1) ->Verify -> CMD20")
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "CMD0 -> CMD8 -> CMD58 -> ACMD41 -> CMD58 ->Verify")

        # Variable declaration
        localVariables['SendOCR'] = localVariables['HcsXpcS18r000']
        localVariables['ExpectOCR'] = localVariables['ReadyCcs18a010']
        localVariables['VerifyType'] = 0
        localVariables['ProtocolMode'] = 4
        ...
        # Set voltage = 3.3V, Max current = globalVDDHMaxCurrent, A2D Rate : 62.5 Hz
        globalHostVoltage = self.__config.get('globalHostVoltage')
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_ACMD41_TC008_SDandSPI_CombinedScenarios(self):
        obj = ACMD41_TC008_SDandSPI_CombinedScenarios(self.vtfContainer)
        obj.Run()
