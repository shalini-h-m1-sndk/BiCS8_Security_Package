...
# SCRIPTER SCRIPT                : UHS_SD3_TC004_CMD19_State_Test.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : UHS_SD3_TC004_CMD19_State_Test.py
# DESCRIPTION                    : Reset Utility
# PRERQUISTE                     : UHS_SD3_UT01_LoadLocal_Variables.py
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=UHS_SD3_TC004_CMD19_State_Test --isModel=false --enable_console_log=1 --adapter=0
...
class UHS_SD3_TC004_CMD19_State_Test(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_UHS_SD3_TC004_CMD19_State_Test(self):
        obj = UHS_SD3_TC004_CMD19_State_Test(self.vtfContainer)
        obj.Run()
