...
# SCRIPTER SCRIPT                : CMD20_UT07_LoadLocal_Variables.st3
# CVF CALL ALL SCRIPT            : CMD20_CA01_SDMode.py
# CVF SCRIPT                     : CMD20_UT07_LoadLocal_Variables.py
# DESCRIPTION                    : Read required variables from params file
# PRERQUISTE                     : CMD20_UT10_Set_Freq_Volt_Timeout.py
...
import CMD20_UT10_Set_Freq_Volt_Timeout as SetFreqVoltTimeOut
...
class CMD20_UT07_LoadLocal_Variables(customize_log):
    def __init__(self, VTFContainer):
        ...
        self.__setFreqVoltTO = SetFreqVoltTimeOut.CMD20_UT10_Set_Freq_Volt_Timeout(self.vtfContainer)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_CMD20_UT07_LoadLocal_Variables(self):
        obj = CMD20_UT07_LoadLocal_Variables(self.vtfContainer)
        obj.Run()
