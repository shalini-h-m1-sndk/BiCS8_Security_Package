...
# SCRIPTER SCRIPT                : CMD20_UT02_GetSequence.st3
# CVF CALL ALL SCRIPT            : CMD20_CA01_SDMode.py
# CVF SCRIPT                     : CMD20_UT02_GetSequence.py
...
class CMD20_UT02_GetSequence(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_CMD20_UT02_GetSequence(self):
        obj = CMD20_UT02_GetSequence(self.vtfContainer)
        obj.Run()
