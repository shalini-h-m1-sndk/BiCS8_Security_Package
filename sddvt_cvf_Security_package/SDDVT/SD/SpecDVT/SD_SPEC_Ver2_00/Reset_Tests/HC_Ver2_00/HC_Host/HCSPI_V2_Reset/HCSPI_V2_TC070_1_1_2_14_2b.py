...
# SCRIPTER SCRIPT                : HCSPI_V2_TC070_1_1_2_14_2b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC070_1_1_2_14_2b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC070_1_1_2_14_2b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC070_1_1_2_14_2b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        """
        Name : Run
        Description : This test is to implement Cmd8, Cmd58 with or without power cycle in SPI mode
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue command - CMD0 with argument as 0
            self.__sdCmdObj.Cmd0()
        ...
        # Variable declaration for Yvariable
        Yvarible = 1
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC070_1_1_2_14_2b(self):
        obj = HCSPI_V2_TC070_1_1_2_14_2b(self.vtfContainer)
        obj.Run()
