...
# SCRIPTER SCRIPT                : HCSPI_V2_TC055_1_1_2_11a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC055_1_1_2_11a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC055_1_1_2_11a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC055_1_1_2_11a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue command CMD8.
            self.__sdCmdObj.Cmd8(cmd8_arg) #default argument is same as cmd8_arg
            ...
            # Call block - function Block_1_1_2_11a_main
            self.Block_1_1_2_11a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_11a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_11a_main is started ---.\n.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_11a_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC055_1_1_2_11a(self):
        obj = HCSPI_V2_TC055_1_1_2_11a(self.vtfContainer)
        obj.Run()
