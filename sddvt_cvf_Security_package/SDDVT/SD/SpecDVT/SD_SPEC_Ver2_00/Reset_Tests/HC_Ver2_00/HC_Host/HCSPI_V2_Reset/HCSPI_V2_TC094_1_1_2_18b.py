...
# SCRIPTER SCRIPT                : HCSPI_V2_TC094_1_1_2_18b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC094_1_1_2_18b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC094_1_1_2_18b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC094_1_1_2_18b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function Block_1_1_2_18b_main()
            self.Block_1_1_2_18b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_18b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--Function- Block_1_1_2_18b_main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--Function- Block_1_1_2_18b_main  is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC094_1_1_2_18b(self):
        obj = HCSPI_V2_TC094_1_1_2_18b(self.vtfContainer)
        obj.Run()
