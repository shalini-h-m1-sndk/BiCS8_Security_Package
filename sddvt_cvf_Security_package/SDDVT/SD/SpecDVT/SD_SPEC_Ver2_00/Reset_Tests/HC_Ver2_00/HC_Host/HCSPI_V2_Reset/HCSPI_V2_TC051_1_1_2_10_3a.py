...
# SCRIPTER SCRIPT                : HCSPI_V2_TC051_1_1_2_10_3a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC051_1_1_2_10_3a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC051_1_1_2_10_3a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC051_1_1_2_10_3a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function Block_1_1_2_10_3a_main()
            self.Block_1_1_2_10_3a_main(Yvarible, cmd1_a41arg, globalProjectConfVar)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Based on globalCardVoltage value, Compare the values of last_cmd_response with globalOCRResValue variation
            if (globalCardVoltage == "LV"):
                if ((last_cmd_response != (globalOCRResValue & 0x00ff8080)) & (last_cmd_response != (globalOCRResValue & 0x40ff8080))):
                    raise ValidationError.TestFailError(self.fn, "Card does not support voltage range.")
    ...
    def Block_1_1_2_10_3a_main(self, Yvarible, cmd1_a41arg, globalProjectConfVar):
        ...
        # Loop for index times, and perform command operations
        for loop in range(0, index):
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Loop count is %s, Current iteration is %s" % (index, (loop + 1)))
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_10_3a_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC051_1_1_2_10_3a(self):
        obj = HCSPI_V2_TC051_1_1_2_10_3a(self.vtfContainer)
        obj.Run()
