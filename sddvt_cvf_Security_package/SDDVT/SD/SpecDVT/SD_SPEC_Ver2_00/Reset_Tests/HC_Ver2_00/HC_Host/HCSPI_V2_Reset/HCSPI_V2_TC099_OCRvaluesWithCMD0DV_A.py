...
# SCRIPTER SCRIPT                : HCSPI_V2_TC099_OCRvaluesWithCMD0DV_A.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC099_OCRvaluesWithCMD0DV_A.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC099_OCRvaluesWithCMD0DV_A --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC099_OCRvaluesWithCMD0DV_A(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC099_OCRvaluesWithCMD0DV_A(self):
        obj = HCSPI_V2_TC099_OCRvaluesWithCMD0DV_A(self.vtfContainer)
        obj.Run()
