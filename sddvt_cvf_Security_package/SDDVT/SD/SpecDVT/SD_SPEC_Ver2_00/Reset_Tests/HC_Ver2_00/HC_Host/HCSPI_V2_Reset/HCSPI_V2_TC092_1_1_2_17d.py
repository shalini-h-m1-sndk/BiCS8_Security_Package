...
# SCRIPTER SCRIPT                : HCSPI_V2_TC092_1_1_2_17d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC092_1_1_2_17d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC092_1_1_2_17d --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC092_1_1_2_17d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue Command 41
            self.__sdCmdObj.ACmd41_SPI(arg = cmd1_a41arg)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC092_1_1_2_17d(self):
        obj = HCSPI_V2_TC092_1_1_2_17d(self.vtfContainer)
        obj.Run()
