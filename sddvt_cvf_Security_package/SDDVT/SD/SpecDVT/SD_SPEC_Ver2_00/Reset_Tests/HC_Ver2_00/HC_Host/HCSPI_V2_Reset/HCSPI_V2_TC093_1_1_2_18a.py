...
# SCRIPTER SCRIPT                : HCSPI_V2_TC093_1_1_2_18a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC093_1_1_2_18a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC093_1_1_2_18a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC093_1_1_2_18a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call Script HCSPI_V2_UT003_Get_last_response.py, function Get_Last_Response()
            ...
            # Call block - function Block_1_1_2_18a_main
            self.Block_1_1_2_18a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_18a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_18a main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_18a main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC093_1_1_2_18a(self):
        obj = HCSPI_V2_TC093_1_1_2_18a(self.vtfContainer)
        obj.Run()
