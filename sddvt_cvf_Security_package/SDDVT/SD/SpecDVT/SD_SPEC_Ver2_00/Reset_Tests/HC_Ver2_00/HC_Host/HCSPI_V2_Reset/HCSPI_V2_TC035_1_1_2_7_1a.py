...
# SCRIPTER SCRIPT                : HCSPI_V2_TC035_1_1_2_7_1a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC035_1_1_2_7_1a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC035_1_1_2_7_1a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC035_1_1_2_7_1a(customize_log):
    ...
    def Block_mismatchCommandRun(self, VOLAValue, cmd1_a41arg):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block 1_1_2_7_1a main - function Block_1_1_2_7_1a_main()
            self.Block_1_1_2_7_1a_main(Yvarible, cmd1_a41arg)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Variable declaration, required for commands argument
            reserve = random.randrange(0, 65536)
            pattern = random.randrange(0, 256)
            cmd8_arg = int((VOLAValue << 8) | (pattern) | (reserve << 12))
            cmd8_exp_resp = (VOLAValue << 8) | (pattern)
    ...
    def Block_1_1_2_7_1a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_7_1a_main is started ---.")
        ...
        elif Yvarible == 2: # CMD argument == 0
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_7_1a_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC035_1_1_2_7_1a(self):
        obj = HCSPI_V2_TC035_1_1_2_7_1a(self.vtfContainer)
        obj.Run()
