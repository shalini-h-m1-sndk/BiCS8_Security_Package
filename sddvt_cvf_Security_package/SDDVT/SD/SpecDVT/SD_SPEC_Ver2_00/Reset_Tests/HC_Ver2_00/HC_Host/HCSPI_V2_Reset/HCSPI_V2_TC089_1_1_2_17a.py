...
# SCRIPTER SCRIPT                : HCSPI_V2_TC089_1_1_2_17a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC089_1_1_2_17a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC089_1_1_2_17a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC089_1_1_2_17a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        # Run the loop for Label Ydef1 1 time (as per Scripter)
        LoopSize = 1
        for Loop in range(0, LoopSize):
            ...
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Loop Ydef1 count is 1, Current iteration is %s" % (Loop + 1))
            ...
            # Issue command - CMD58
            try:
                last_resp = self.__sdCmdObj.Cmd58_SPI()
            ...
            # Card Reset ini SDinSPI mode
            self.__dvtLib.Reset(sdcmdWrap.CARD_MODE.SD_IN_SPI, ocr=0, cardSlot=0x1, sendCmd8=True, initInfo=None,
                                rca=0x0, time=0x0, sendCMD0=0x1, bHighCapacity=True, bSendCMD58=True, version=0,
                                VOLA=globalVOLAValue, cmdPattern=configPatternFiledInCMD8, reserved=0x0, sendCMD1 = True)
        ...
        # Run the loop for Label Ydef2 1 time (as per Scripter)
        LoopSize = 1
        for Loop in range(0, LoopSize):
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "LABEL Ydef2 execution is started.")
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Loop Ydef2 count is 1, Current iteration is %s" % (Loop + 1))
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC089_1_1_2_17a(self):
        obj = HCSPI_V2_TC089_1_1_2_17a(self.vtfContainer)
        obj.Run()
