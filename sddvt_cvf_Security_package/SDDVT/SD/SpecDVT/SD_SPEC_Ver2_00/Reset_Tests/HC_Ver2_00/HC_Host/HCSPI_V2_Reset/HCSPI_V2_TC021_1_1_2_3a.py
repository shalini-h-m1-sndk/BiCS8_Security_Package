...
# SCRIPTER SCRIPT                : HCSPI_V2_TC021_1_1_2_3a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC021_1_1_2_3a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC021_1_1_2_3a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC021_1_1_2_3a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # last_cmd_response initialization
            ...
            # Call block 1_1_2_3a main - function Block_1_1_2_3a_main
            self.Block_1_1_2_3a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_3a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_3a main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_3a_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC021_1_1_2_3a(self):
        obj = HCSPI_V2_TC021_1_1_2_3a(self.vtfContainer)
        obj.Run()
