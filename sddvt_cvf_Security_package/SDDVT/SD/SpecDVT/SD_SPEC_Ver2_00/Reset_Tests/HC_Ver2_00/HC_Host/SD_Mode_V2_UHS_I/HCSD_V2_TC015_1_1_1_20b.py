...
# SCRIPTER SCRIPT                : HCSD_V2_TC015_1_1_1_20b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSD_V2_TC015_1_1_1_20b.py
...
# TEST ARGUMENTS                 : --test=HCSD_V2_TC015_1_1_1_20b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSD_V2_TC015_1_1_1_20b(customize_log):
    ...
    def Run(self):
        ...
        # Set Loop Repeat1_CMD8s_SD_HIGH
        for Repeat1_CMD8s_SD_HIGH in range(0, index):   # Repeat CMD8 random number of iterations
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Repeat1_CMD8s_SD_HIGH loop count is %s times. Current iteration is %s" % ((index + 1), (Repeat1_CMD8s_SD_HIGH + 1)))
            ...
            # Run cmd55()
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "RUNNING SINGLE CMD: Cmd55()")
            self.__sdCmdObj.Cmd55(setRCA=True)

            # Run cmd8() and verify reponse
        ...
        # Set Label Repeat2_CMD8s_SD_HIGH and Run cmd55() and cmd8()
        for Repeat2_CMD8s_SD_HIGH in range(0, index):   # Repeat CMD8 random number of iterations
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Repeat2_CMD8s_SD_HIGH loop count is %s times. Current iteration is %s" % ((index + 1), (Repeat2_CMD8s_SD_HIGH + 1)))
        ...
        #***Test CMD55 Before CMD8 during Power Cycle & CMD 0 Reset******
        ...
        # Set Loop Repeat3_CMD8s_SD_HIGH
        for Repeat3_CMD8s_SD_HIGH in range(0, index):   # Repeat CMD8 random number of iterations
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Repeat3_CMD8s_SD_HIGH loop count is %s times. Current iteration is %s" % ((index + 1), (Repeat3_CMD8s_SD_HIGH + 1)))
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSD_V2_TC015_1_1_1_20b(self):
        obj = HCSD_V2_TC015_1_1_1_20b(self.vtfContainer)
        obj.Run()
