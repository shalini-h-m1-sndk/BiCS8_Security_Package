...
# SCRIPTER SCRIPT                : HCSPI_V2_TC019_1_1_2_2_4c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC019_1_1_2_2_4c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC019_1_1_2_2_4c --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR [Referred Scripter/CTF] : Sivagurunathan
# REVIEWED BY                    : None
# DATE                           : 30-May-2024
# UPDATED BY                     : Sushmitha P.S
# UPDATED DATE                   : 17-Sep-2024
################################################################################
"""
...
class HCSPI_V2_TC019_1_1_2_2_4c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        # loop for Label Ydef1 three times (as per Scripter)
        LoopSize = 3
        for Loop in range(0, LoopSize):
            ...
            # Call block 1_1_2_2_4c main - function Block_1_1_2_2_4c_main
            self.Block_1_1_2_2_4c_main(Yvarible, cmd1_a41arg)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue Cmd8 and compare the value of command response with cmd8_exp_resp
            last_cmd_response = 0 # for initialization only

            # Loop for loop_count times, Issue Cmd8 and compare the value of command response with cmd8_arg
            for loop in range(0, loop_count):
                self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Loop count is %s, Current iteration is %s" % (loop_count, (loop + 1)))
    ...
    def Block_1_1_2_2_4c_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_4c main is started ---.")
        ...
        # Issue Command 1
        last_resp = self.__sdCmdObj.Cmd1(cmd1_a41arg) # R1 response
        ...
        # RESET card in SPI mode
        globalOCRResValue = int(self.__config.get('globalOCRResValue'))
        self.__dvtLib.Reset(sdcmdWrap.CARD_MODE.SD_IN_SPI, ocr=0xFF8000, cardSlot=0x1, sendCmd8=True,initInfo=None,rca=0x0, time=0x0,
                             sendCMD0=0x1,bHighCapacity=True,bSendCMD58=True,version=0,VOLA=0x1,cmdPattern=0xAA,reserved=0x0,
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_4c main main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC019_1_1_2_2_4c(self):
        obj = HCSPI_V2_TC019_1_1_2_2_4c(self.vtfContainer)
        obj.Run()
