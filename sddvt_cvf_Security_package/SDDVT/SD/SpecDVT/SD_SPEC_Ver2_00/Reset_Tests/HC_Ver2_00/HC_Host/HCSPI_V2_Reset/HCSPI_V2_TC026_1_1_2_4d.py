...
# SCRIPTER SCRIPT                : HCSPI_V2_TC026_1_1_2_4d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC026_1_1_2_4d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC026_1_1_2_4d --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC026_1_1_2_4d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block 1_1_2_4d main - function Block_1_1_2_4d_main
            self.Block_1_1_2_4d_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_4d_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_4d_main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_4d_main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC026_1_1_2_4d(self):
        obj = HCSPI_V2_TC026_1_1_2_4d(self.vtfContainer)
        obj.Run()
