...
# SCRIPTER SCRIPT                : HCSPI_V2_TC052_1_1_2_10_3b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC052_1_1_2_10_3b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC052_1_1_2_10_3b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC052_1_1_2_10_3b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        # Set Label Ydef1
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "----------- CMD58 before CMD8 ---------")
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "----------- Set Label Ydef1 ---------")

        # e loop for Label Ydef1 three times (as per Scripter)
        LoopSize = 3
        for Loop in range(0, LoopSize):
            ...
            # Issue command - CMD58.
            self.__sdCmdObj.Cmd58_SPI() # this command will be executed.
            ...
            # Loop for index times, Issue Cmd8 and compare the value of command response with cmd8_arg
            ...
            # Call function Block_1_1_2_10_3b_main()
            self.Block_1_1_2_10_3b_main(Yvarible, cmd1_a41arg, globalProjectConfVar)
        ...
        # TAG: ********* CMD58 before CMD8 during Power Cycle & CMD0 Reset*********
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "********* CMD58 before CMD8 during Power Cycle & CMD0 Reset*********")
    ...
    def Block_1_1_2_10_3b_main(self, Yvarible, cmd1_a41arg, globalProjectConfVar):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--Function- Block_1_1_2_10_3b_main is started ---.")
        ...
        # Compare last_cmd_response and globalOCRResValue values
        ...
        # Loop for index times, Issue command 8 and compare the command response with cmd8_arg
        for loop in range(0, index):
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Loop count is %s, Current iteration is %s" % (index, (loop + 1)))
            ...
            # Based on globalCardVoltage value of HV or LV, assign cmd8_exp_resp value
            if(globalCardVoltage == "HV"):
                if(VOLAvalue == 1):
                    cmd8_exp_resp = int((VOLAvalue << 8) | (pattern))
                else:
                    cmd8_exp_resp = (pattern)
            ...
            # Issue Command 8 with argument cmd8_arg
            self.__sdCmdObj.Cmd8(cmd8_arg)

            # Call script HCSPI_V2_UT003_Get_last_response.py
            last_cmd_response = self.__Get_last_response.Run()

            # Compare last_cmd_response  and cmd8_exp_respv
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--Function- Block_1_1_2_10_3b_main  is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC052_1_1_2_10_3b(self):
        obj = HCSPI_V2_TC052_1_1_2_10_3b(self.vtfContainer)
        obj.Run()
