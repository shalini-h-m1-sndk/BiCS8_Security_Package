...
# SCRIPTER SCRIPT                : HCSPI_V2_TC053_1_1_2_10_3c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC053_1_1_2_10_3c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC053_1_1_2_10_3c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC053_1_1_2_10_3c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # check for globalCardVoltage & Compare value of last_cmd_response with globalOCRResValue variation
            ...
            # Call function- Block_1_1_2_10_3c_main()
            self.Block_1_1_2_10_3c_main(Yvarible, cmd1_a41arg, globalProjectConfVar)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Check for globalCardVoltage & Compare the values of last_cmd_response with globalOCRResValue variation
            if (globalCardVoltage == "LV"):
                if ((last_cmd_response != (globalOCRResValue & 0x00ff8080)) & (last_cmd_response != (globalOCRResValue & 0x40ff8080))):
                    raise ValidationError.TestFailError(self.fn, "Card does not support voltage range.")

                self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Card support voltage range.")
            else:
                if ((last_cmd_response != (globalOCRResValue & 0x00ff8000)) & (last_cmd_response != (globalOCRResValue & 0x40ff8000))):
                    raise ValidationError.TestFailError(self.fn, "Card does not support voltage range.")
    ...
    def Block_1_1_2_10_3c_main(self, Yvarible, cmd1_a41arg, globalProjectConfVar):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Function - Block_1_1_2_10_3c_main() is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Function - Block_1_1_2_10_3c_main() is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC053_1_1_2_10_3c(self):
        obj = HCSPI_V2_TC053_1_1_2_10_3c(self.vtfContainer)
        obj.Run()
