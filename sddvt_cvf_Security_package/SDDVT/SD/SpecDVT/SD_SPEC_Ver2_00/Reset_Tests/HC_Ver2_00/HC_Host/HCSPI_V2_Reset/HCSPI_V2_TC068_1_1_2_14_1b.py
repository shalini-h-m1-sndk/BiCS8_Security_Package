...
# SCRIPTER SCRIPT                : HCSPI_V2_TC068_1_1_2_14_1b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC068_1_1_2_14_1b.py
# DESCRIPTION                    : Module to implement Cmd58, card reset with or without power cycle in SPI mode
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC068_1_1_2_14_1b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC068_1_1_2_14_1b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Compare globalOCRResValue with last_cmd_response
            ...
            # Call block - function Block_1_1_2_14_1b_main()
            self.Block_1_1_2_14_1b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_14_1b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_14_1b_main is started ---.\n.")
        last_resp = ServiceWrap.Buffer.CreateBuffer(1, 0x00)

        globalResetTO = int(self.__config.get('globalResetTO'))
        globalOCRResValue = int(self.__config.get('globalOCRResValue'))

        # Check for Yvariable value as 1 and Run the loop for value globalResetTO or last_resp == 0
        if Yvarible == 1:
            for loop in range(0, globalResetTO):
                ...
                # Issue Command - Cmd1 with argument as cmd1_a41arg
            ...
            # Check for Yvariable == 2 value. Issue command 1, check response and Run the loop for value globalResetTO for command 1 or last_resp == 0
            last_resp = self.__sdCmdObj.Cmd1(cmd1_a41arg)
            ...
            for loop in range(0, globalResetTO):
                ...
                # Issue command 1 with argument 0
            ...
            # Issue command 1 with argument as cmd1_a41arg
            last_resp = self.__sdCmdObj.Cmd1(cmd1_a41arg)
            if (last_resp.GetTwoBytesToInt(offset = 0) != 0x100):
                raise ValidationError.TestFailError(self.fn, "Last response is not equal to 0x100")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_14_1b_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC068_1_1_2_14_1b(self):
        obj = HCSPI_V2_TC068_1_1_2_14_1b(self.vtfContainer)
        obj.Run()
