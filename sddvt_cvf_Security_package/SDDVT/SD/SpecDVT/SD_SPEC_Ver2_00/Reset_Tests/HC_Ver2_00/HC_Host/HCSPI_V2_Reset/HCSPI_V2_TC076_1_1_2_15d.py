...
# SCRIPTER SCRIPT                : HCSPI_V2_TC076_1_1_2_15d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC076_1_1_2_15d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC076_1_1_2_15d --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC076_1_1_2_15d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        # Code for section "CMD58 before CMD8 with Power Cycle" is started
        ...
        # Set frequency to 300 KHz
        self.__GlobalSetResetFreq.Run()
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-------------CMD58 before CMD8 with Power Cycle completed ----------.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC076_1_1_2_15d(self):
        obj = HCSPI_V2_TC076_1_1_2_15d(self.vtfContainer)
        obj.Run()
