...
# SCRIPTER SCRIPT                : HCSPI_V2_TC025_1_1_2_4c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC025_1_1_2_4c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC025_1_1_2_4c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC025_1_1_2_4c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block 1_1_2_4c main - function Block_1_1_2_4c_main
            self.Block_1_1_2_4c_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_4c_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "\n --- Block_1_1_2_4c main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_4c_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC025_1_1_2_4c(self):
        obj = HCSPI_V2_TC025_1_1_2_4c(self.vtfContainer)
        obj.Run()
