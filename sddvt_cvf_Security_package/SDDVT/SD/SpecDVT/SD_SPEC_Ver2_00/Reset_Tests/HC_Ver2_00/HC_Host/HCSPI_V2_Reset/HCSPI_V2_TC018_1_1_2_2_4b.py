...
# SCRIPTER SCRIPT                : HCSPI_V2_TC018_1_1_2_2_4b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC018_1_1_2_2_4b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC018_1_1_2_2_4b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC018_1_1_2_2_4b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block Block_1_1_2_2_3b main - function Block_1_1_2_2_3b_main
            self.Block_1_1_2_2_4b_main(Yvarible, cmd1_a41arg)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block Block_1_1_2_2_4b main - function Block_1_1_2_2_4b_main
            self.Block_1_1_2_2_4b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_2_4b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_4b main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2__4b main main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC018_1_1_2_2_4b(self):
        obj = HCSPI_V2_TC018_1_1_2_2_4b(self.vtfContainer)
        obj.Run()
