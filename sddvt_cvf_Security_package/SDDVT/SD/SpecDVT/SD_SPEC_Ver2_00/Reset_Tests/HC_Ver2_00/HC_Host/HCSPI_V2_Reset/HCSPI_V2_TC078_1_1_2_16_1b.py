...
# SCRIPTER SCRIPT                : HCSPI_V2_TC078_1_1_2_16_1b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC078_1_1_2_16_1b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC078_1_1_2_16_1b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC078_1_1_2_16_1b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function Block_1_1_2_16_1b_main()
            self.Block_1_1_2_16_1b_main(Yvarible, cmd1_a41arg, cmd8_arg)
    ...
    def Block_1_1_2_16_1b_main(self, Yvarible, cmd1_a41arg, cmd8_arg):
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_16_1b_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC078_1_1_2_16_1b(self):
        obj = HCSPI_V2_TC078_1_1_2_16_1b(self.vtfContainer)
        obj.Run()
