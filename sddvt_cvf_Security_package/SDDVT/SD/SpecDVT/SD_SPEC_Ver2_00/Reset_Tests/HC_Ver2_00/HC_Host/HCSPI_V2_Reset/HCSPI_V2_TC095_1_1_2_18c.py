...
# SCRIPTER SCRIPT                : HCSPI_V2_TC095_1_1_2_18c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC095_1_1_2_18c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC095_1_1_2_18c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC095_1_1_2_18c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function Block_1_1_2_18c_main()
            self.Block_1_1_2_18c_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_18c_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Function - Block_1_1_2_18c_main() is started ---.")
        ...
        if Yvarible == 1:
            for loop in range(0, globalResetTO):
                ...
                # Issue command 1 with cmd1_a41arg argument
            ...
            # Issue Cmd 1 with cmd1_a41arg argument
            last_resp = self.__sdCmdObj.Cmd1(cmd1_a41arg)
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Function - Block_1_1_2_18c_main() is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC095_1_1_2_18c(self):
        obj = HCSPI_V2_TC095_1_1_2_18c(self.vtfContainer)
        obj.Run()
