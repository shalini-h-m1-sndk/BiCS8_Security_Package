...
# SCRIPTER SCRIPT                : HCSPI_V2_TC064_1_1_2_13b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC064_1_1_2_13b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC064_1_1_2_13b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC064_1_1_2_13b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue command CMD8 with argument as cmd8_arg
            ...
            # Call block - function Block_1_1_2_13b_main
            self.Block_1_1_2_13b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_13b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_13b_main is started ---.\n.")
        ...
        if Yvarible == 1:
            for loop in range(0, globalResetTO):
                ...
                #Variable declarations
                reserve = random.randrange(0, 1073741824)
                cmd1_a41arg = int(0xC0000000 | reserve)
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_13b_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC064_1_1_2_13b(self):
        obj = HCSPI_V2_TC064_1_1_2_13b(self.vtfContainer)
        obj.Run()
