...
# SCRIPTER SCRIPT                : HCSPI_V2_TC067_1_1_2_14_1a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC067_1_1_2_14_1a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC067_1_1_2_14_1a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC067_1_1_2_14_1a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block - function Block_1_1_2_14_1a_main()
            self.Block_1_1_2_14_1a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_14_1a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_14_1a_main is started ---.\n.")
        ...
        if (last_cmd_response == globalOCRResValue):
            raise ValidationError.TestFailError(self.fn, "Expected Card did not complete init.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_14_1a_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC067_1_1_2_14_1a(self):
        obj = HCSPI_V2_TC067_1_1_2_14_1a(self.vtfContainer)
        obj.Run()
