...
# SCRIPTER SCRIPT                : HCSPI_V2_TC049_1_1_2_10_2c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC049_1_1_2_10_2c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC049_1_1_2_10_2c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC049_1_1_2_10_2c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function Block_1_1_2_10_2c_main()
            self.Block_1_1_2_10_2c_main(Yvarible, cmd1_a41arg, cmd8_arg)
    ...
    def Block_1_1_2_10_2c_main(self, Yvarible, cmd1_a41arg, cmd8_arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Function - Block_1_1_2_10_2c_main() is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Function - Block_1_1_2_10_2c_main() is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC049_1_1_2_10_2c(self):
        obj = HCSPI_V2_TC049_1_1_2_10_2c(self.vtfContainer)
        obj.Run()
