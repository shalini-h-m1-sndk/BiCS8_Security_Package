...
# SCRIPTER SCRIPT                : HCSD_V2_TC003_1_1_1_2a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSD_V2_TC003_1_1_1_2a.py
# DESCRIPTION                    : Test CMD8 sequence during Soft Reset, Power Cycle Reset, Power Cycle & CMD0 Reset.
# PRERQUISTE                     : HCSD_V2_UT01_AddressForWriteRead.py
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=HCSD_V2_TC003_1_1_1_2a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSD_V2_TC003_1_1_1_2a(customize_log):
    ...
    def Run(self):
        ...
        # RESET card
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "RESET card with CMD8 and IDENTIFICATION of the card")
        ...
        VOLA_arg = globalVOLAValue << 8

        # ***Test Sequential of CMD8's during Soft Reset***
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "******Test Sequential of CMD8's during Soft Reset******")
        ...
        # Set Label: Repeat1_CMD8s_SD_HIGH
        for Repeat1_CMD8_SD_HIGH in range(index):   # Reapet CMD8 random number of iterations
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop Repeat1_CMD8_SD_HIGH for %d times" % Repeat1_CMD8_SD_HIGH)

            # Variable Declaration Operation
            pattern = random.randrange(0, 256)
            reserve = random.randrange(0, 1048576)
            arg = ((VOLA_arg | pattern) | (reserve << 12))
            exp = (VOLA_arg | pattern)

            # Run cmd8()
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "RUNNING Cmd8")
        ...
        # Run AddressForWriteRead to perform Write & Read  operation on blocks.
        ...
        # ***Test Sequential of CMD8's during Power Cycle Reset***
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "***Test Sequential of CMD8's during Power Cycle Reset***")
        ...
        # Set Repeat2_CMD8s_SD_HIGH label
        for Repeat2_CMD8_SD_HIGH in range(0, index):    # Repeat CMD8 random number of iterations
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop Repeat2_CMD8_SD_HIGH for %d times " %Repeat2_CMD8_SD_HIGH )
        ...
        # Set Repeat3_CMD8_SD_HIGH label
        for Repeat3_CMD8_SD_HIGH in range(index):   # Repeat CMD8 random number of iterations
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop Repeat3_CMD8_SD_HIGH for %d times " %Repeat3_CMD8_SD_HIGH )
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSD_V2_TC003_1_1_1_2a(self):
        obj = HCSD_V2_TC003_1_1_1_2a(self.vtfContainer)
        obj.Run()
