...
# SCRIPTER SCRIPT                : HCSPI_V2_TC003_1_1_2_1c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC003_1_1_2_1c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC003_1_1_2_1c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC003_1_1_2_1c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Compare the value of last_cmd_response with globalOCRResValue variation
            ...
            # Call block - function Block_1_1_2_1c_main
            self.Block_1_1_2_1c_main(Yvarible, cmd1_a41arg)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Compare the value of last_cmd_response
            if ((last_cmd_response != (globalOCRResValue & 0x00ff8080)) & (last_cmd_response != (globalOCRResValue & 0x40ff8080))):
                raise ValidationError.TestFailError(self.fn, "Card does not support voltage range.")
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Card supports voltage range.")
    ...
    def Block_1_1_2_1c_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "\n --- BLOCK 1_1_2_1c main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_1c main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC003_1_1_2_1c(self):
        obj = HCSPI_V2_TC003_1_1_2_1c(self.vtfContainer)
        obj.Run()
