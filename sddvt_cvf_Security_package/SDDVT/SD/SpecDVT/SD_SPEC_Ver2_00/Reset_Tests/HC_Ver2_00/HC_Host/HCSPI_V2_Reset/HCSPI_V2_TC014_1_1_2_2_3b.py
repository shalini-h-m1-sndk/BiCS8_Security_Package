...
# SCRIPTER SCRIPT                : HCSPI_V2_TC014_1_1_2_2_3b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC014_1_1_2_2_3b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC014_1_1_2_2_3b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC014_1_1_2_2_3b(customize_log):
        ...
        for Loop in range(0, LoopSize):
            ...
            for loop in range(0, index):
                ...
                if (last_cmd_response != cmd8_arg):
                    raise ValidationError.TestFailError(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Incorrect Cmd8 response.")
            ...
            self.Block_1_1_2_2_3b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_2_3b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_3b main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2__3b_main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC014_1_1_2_2_3b(self):
        obj = HCSPI_V2_TC014_1_1_2_2_3b(self.vtfContainer)
        obj.Run()
