...
# SCRIPTER SCRIPT                : HCSPI_V2_TC085_1_1_2_16_3a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC085_1_1_2_16_3a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC085_1_1_2_16_3a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC085_1_1_2_16_3a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function - Block_1_1_2_16_3a_reset_OK()
            self.Block_1_1_2_16_3a_reset_OK(Yvarible, cmd1_a41arg)
            ...
            # Call function - Block_1_1_2_16_3a_no_reset()
            self.Block_1_1_2_16_3a_no_reset(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_16_3a_reset_OK(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-------------- Block_1_1_2_16_3a_reset_OK is started --------------.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "------------ Block_1_1_2_16_3a_reset_OK is completed -----------------.\n")


    def Block_1_1_2_16_3a_no_reset(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-------------- Block_1_1_2_16_3a_no_reset is started --------------.")
        last_resp = ServiceWrap.Buffer.CreateBuffer(1, 0x00)
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "------------ Block_1_1_2_16_3a_no_reset is completed -----------------.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC085_1_1_2_16_3a(self):
        obj = HCSPI_V2_TC085_1_1_2_16_3a(self.vtfContainer)
        obj.Run()
