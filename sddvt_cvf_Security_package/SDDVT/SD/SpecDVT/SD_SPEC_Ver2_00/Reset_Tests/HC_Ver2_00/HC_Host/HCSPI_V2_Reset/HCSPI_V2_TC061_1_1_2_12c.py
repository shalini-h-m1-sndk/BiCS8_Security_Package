...
# SCRIPTER SCRIPT                : HCSPI_V2_TC061_1_1_2_12c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC061_1_1_2_12c.py
# DESCRIPTION                    : To Test Reset Functionality in SPI mode
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC061_1_1_2_12c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC061_1_1_2_12c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block - function Block_1_1_2_12c_main
            self.Block_1_1_2_12c_main(Yvarible, cmd1_a41arg, cmd8_arg)
    ...
    def Block_1_1_2_12c_main(self, Yvarible, cmd1_a41arg, cmd8_arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_12c main is started ---.")
        ...
        if Yvarible == 1:
            ...
            for loop in range(0, globalResetTO):
                ...
                # Issue command 41
                last_resp = self.__sdCmdObj.ACmd41_SPI(arg=0x00)
                time.sleep(0.001)   # 1 milli second
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_12c main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC061_1_1_2_12c(self):
        obj = HCSPI_V2_TC061_1_1_2_12c(self.vtfContainer)
        obj.Run()
