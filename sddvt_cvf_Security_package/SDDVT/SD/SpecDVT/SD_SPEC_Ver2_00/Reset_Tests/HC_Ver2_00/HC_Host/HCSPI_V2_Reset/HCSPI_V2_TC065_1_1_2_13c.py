...
# SCRIPTER SCRIPT                : HCSPI_V2_TC065_1_1_2_13c.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC065_1_1_2_13c.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC065_1_1_2_13c --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC065_1_1_2_13c(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        # Variable declarations, as per SD Spec 2 & globalPreTestingSettings.st3
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue command - CMD58 and Call script HCSPI_V2_UT003_Get_last_response.py
            ...
            # Call function - Block_1_1_2_13c_main()
            self.Block_1_1_2_13c_main(Yvarible, cmd1_a41arg)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue command - CMD58, Call Script HCSPI_V2_UT003_Get_last_response.py
            self.__sdCmdObj.Cmd58_SPI()
            last_cmd_response = self.__Get_last_response.Run()
            ...
            # Call block - function Block_1_1_2_13c_main
            self.Block_1_1_2_13c_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_13c_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_13c_main() is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_13c_main() is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC065_1_1_2_13c(self):
        obj = HCSPI_V2_TC065_1_1_2_13c(self.vtfContainer)
        obj.Run()
