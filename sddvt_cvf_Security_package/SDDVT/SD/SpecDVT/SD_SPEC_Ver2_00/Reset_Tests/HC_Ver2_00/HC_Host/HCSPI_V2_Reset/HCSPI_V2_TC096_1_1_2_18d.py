...
# SCRIPTER SCRIPT                : HCSPI_V2_TC096_1_1_2_18d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC096_1_1_2_18d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC096_1_1_2_18d --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC096_1_1_2_18d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block - function Block_1_1_2_18d_main
            self.Block_1_1_2_18d_main(Yvarible, cmd1_a41arg)
            ...
            # # Compare value for last_cmd_response and 5
            # if ((last_cmd_response.GetOneByteToInt(0) & 5) != 5):
            #     raise ValidationError.TestFailError(self.fn, "Compare value for last_cmd_response and 5 Failed !!!.")
            # else:
            #     self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Compare value for last_cmd_response and 5.")
            ...
            if (last_cmd_response != globalOCRResValue):
                ...
                self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Card support voltage range, correct response")
    ...
    def Block_1_1_2_18d_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_18d main is started ---.")
        ...
        if Yvarible == 1:
            for loop in range(0, globalResetTO):
                ...
                # Issue cmd1 with arg = cmd1_a41arg
            ...
            for loop in range(0, globalResetTO):
                ...
                # Issue Cmd1
                last_resp = self.__sdCmdObj.Cmd1(0x00)
                time.sleep(0.001)   # 1 milli second
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC096_1_1_2_18d(self):
        obj = HCSPI_V2_TC096_1_1_2_18d(self.vtfContainer)
        obj.Run()
