...
# SCRIPTER SCRIPT                : HCSPI_V2_TC020_1_1_2_2_4d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC020_1_1_2_2_4d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC020_1_1_2_2_4d --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC020_1_1_2_2_4d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block - function Block_1_1_2_2_4d main
            self.Block_1_1_2_2_4d_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_2_4d_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_4d main is started ---.")
        ...
        globalOCRResValue = int(self.__config.get('globalOCRResValue'))
        self.__dvtLib.Reset(sdcmdWrap.CARD_MODE.SD_IN_SPI, ocr=16744448, cardSlot=0x1, sendCmd8=True, initInfo=None,
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_4d main main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC020_1_1_2_2_4d(self):
        obj = HCSPI_V2_TC020_1_1_2_2_4d(self.vtfContainer)
        obj.Run()
