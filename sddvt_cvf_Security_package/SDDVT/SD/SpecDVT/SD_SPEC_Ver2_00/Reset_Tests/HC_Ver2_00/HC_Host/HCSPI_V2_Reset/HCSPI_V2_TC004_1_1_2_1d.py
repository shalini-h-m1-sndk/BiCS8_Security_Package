...
# SCRIPTER SCRIPT                : HCSPI_V2_TC004_1_1_2_1d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC004_1_1_2_1d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC004_1_1_2_1d --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR [Referred Scripter/CTF] : Sivagurunathan
# REVIEWED BY                    : None
# DATE                           : Nov-2022
# UPDATED BY                     : Mahalaxmi Nalwad
# UPDATED DATE                   : 12-Sep-2024
################################################################################
"""
...
class HCSPI_V2_TC004_1_1_2_1d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Compare value for last_cmd_response and globalOCRResValue
            ...
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Card supports voltage range, correct response")

            # Call block - function Block_1_1_2_1d_main
            self.Block_1_1_2_1d_main(Yvarible, cmd1_a41arg)
        ...
        for Loop in range(0, LoopSize):
            ...
            # Compare last_cmd_response and globalOCRResValue
            if ((last_cmd_response != (globalOCRResValue & 0x00ff8000)) & (last_cmd_response != (globalOCRResValue & 0x40ff8000))):
                raise ValidationError.TestFailError(self.fn, "Card does not support voltage range")
    ...
    def Block_1_1_2_1d_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_1d main is started ---.")
        ...
        # Issue Command Cmd58
        self.__sdCmdObj.Cmd58_SPI() # default argument is0
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_1d main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC004_1_1_2_1d(self):
        obj = HCSPI_V2_TC004_1_1_2_1d(self.vtfContainer)
        obj.Run()
