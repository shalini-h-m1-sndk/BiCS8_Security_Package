...
# SCRIPTER SCRIPT                : HCSPI_V2_TC036_1_1_2_7_1b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC036_1_1_2_7_1b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC036_1_1_2_7_1b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC036_1_1_2_7_1b(customize_log):
    ...
    def Block_mismatchCommandRun(self, VOLAValue, cmd1_a41arg):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function Block_1_1_2_7_1b_main()
            self.Block_1_1_2_7_1b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_7_1b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_7_1b_main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_7_1b_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC036_1_1_2_7_1b(self):
        obj = HCSPI_V2_TC036_1_1_2_7_1b(self.vtfContainer)
        obj.Run()
