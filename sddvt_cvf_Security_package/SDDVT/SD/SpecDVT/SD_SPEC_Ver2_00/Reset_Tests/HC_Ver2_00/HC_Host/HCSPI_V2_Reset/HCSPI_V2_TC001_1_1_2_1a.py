...
# SCRIPTER SCRIPT                : HCSPI_V2_TC001_1_1_2_1a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC001_1_1_2_1a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC001_1_1_2_1a --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR [Referred Scripter/CTF] : Sivagurunathan
# REVIEWED BY                    : None
# DATE                           : Nov-2022
# UPDATED BY                     : Karthik Patil
# UPDATED DATE                   : 13-Sept-2024
################################################################################
"""
...
class HCSPI_V2_TC001_1_1_2_1a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call block - function Block_1_1_2_1a_main
            self.Block_1_1_2_1a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_1a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_1a main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- BLOCK 1_1_2_1a main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC001_1_1_2_1a(self):
        obj = HCSPI_V2_TC001_1_1_2_1a(self.vtfContainer)
        obj.Run()
