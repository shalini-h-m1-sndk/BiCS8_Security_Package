...
# SCRIPTER SCRIPT                : HCSPI_V2_TC028_1_1_2_5b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC028_1_1_2_5b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC028_1_1_2_5b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC028_1_1_2_5b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            cmd8_arg = int((globalVOLAValue << 8) | (configPatternFiledInCMD8) | (reserve << 12))
            cmd8_exp_resp = int((globalVOLAValue << 8) | (configPatternFiledInCMD8))
            ...
            # Call function Block_1_1_2_5b_main
            self.Block_1_1_2_5b_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_5b_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_5b_main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_5b_main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC028_1_1_2_5b(self):
        obj = HCSPI_V2_TC028_1_1_2_5b(self.vtfContainer)
        obj.Run()
