...
# SCRIPTER SCRIPT                : HCSPI_V2_TC080_1_1_2_16_1d.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC080_1_1_2_16_1d.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC080_1_1_2_16_1d --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC080_1_1_2_16_1d(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        # Check for VOLAValue for HV and LV and continue VolaMissmatch1 loop
        ...
        # Set Label Ydef1 and run loop for 3 times
        ...
        for Loop in range(0, LoopSize):
            ...
            cmd8_arg = (VOLAvalue << 8) | (pattern) | (reserve << 12)
            ...
            # Call function Block_1_1_2_16_1d_main()
            self.Block_1_1_2_16_1d_main(Yvarible, cmd1_a41arg, cmd8_arg)
        ...
        # Set Label Ydef2 and run loop for 3 times
        LoopSize = 3
        for Loop in range(0, LoopSize):
    ...
    def Block_1_1_2_16_1d_main(self, Yvarible, cmd1_a41arg, cmd8_arg):
        """
        This block runs Cmd1 for cmd1_a41arg for different values of Yvarible
        """

        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "\n[INFO] --- Block_1_1_2_16_1d_main is started ---.")
        ...
        if Yvarible == 1:
            for loop in range(0, globalResetTO):
                ...
                last_resp = self.__sdCmdObj.ACmd41_SPI(arg=cmd1_a41arg)
            ...
            for loop in range(0, globalResetTO):
                ...
                self.__sdCmdObj.Cmd55()
                last_resp = self.__sdCmdObj.ACmd41_SPI(arg=0x0)
            ...
            for loop in range(0, globalResetTO):
                ...
                ARG = bit << 30
                self.__sdCmdObj.Cmd55()
                last_resp = self.__sdCmdObj.ACmd41_SPI(arg=ARG)
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-- Block_1_1_2_16_1d_main is completed ---.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC080_1_1_2_16_1d(self):
        obj = HCSPI_V2_TC080_1_1_2_16_1d(self.vtfContainer)
        obj.Run()
