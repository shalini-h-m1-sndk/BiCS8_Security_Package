...
# SCRIPTER SCRIPT                : HCSPI_V2_TC098_OCRvaluesInPowerCycleWithCMD0DV_B.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC098_OCRvaluesInPowerCycleWithCMD0DV_B.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC098_OCRvaluesInPowerCycleWithCMD0DV_B --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC098_OCRvaluesInPowerCycleWithCMD0DV_B(customize_log):
    ...
    def Block_main(self, cmd1_a41arg, cmd8_arg, globalProjectConfVar, loop_count):
        ...
        if ((cmd1_a41arg & 0x40000000) != 0):
            ...
            if ((last_resp.GetTwoBytesToInt(offset = 0) & 0x5) != 5):   # In case no init expected
                raise ValidationError.TestFailError(self.fn,  "Card does not support voltage range!")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC098_OCRvaluesInPowerCycleWithCMD0DV_B(self):
        obj = HCSPI_V2_TC098_OCRvaluesInPowerCycleWithCMD0DV_B(self.vtfContainer)
        obj.Run()
