...
# SCRIPTER SCRIPT                : HCSPI_V2_TC086_1_1_2_16_3b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC086_1_1_2_16_3b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC086_1_1_2_16_3b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC086_1_1_2_16_3b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Call function - Block_1_1_2_16_3b_reset_OK()
            self.Block_1_1_2_16_3b_reset_OK(Yvarible, cmd1_a41arg)
            ...
            # Call function - Block_1_1_2_16_3b_no_reset()
            self.Block_1_1_2_16_3b_no_reset(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_16_3b_reset_OK(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-------------- Block_1_1_2_16_3b_reset_OK is started --------------.")
        ...
        if Yvarible == 1:
            for loop in range(0, globalResetTO):
                ...
                # Issue Command , Cmd1 with argument cmd1_a41arg
            ...
            # Issue command 1 with argument cmd1_a41arg
            last_resp = self.__sdCmdObj.Cmd1(cmd1_a41arg)
            ...
            for loop in range(0, globalResetTO):
                ...
                # Issue command 1 with argument 0 and check last_resp value
            ...
            for loop in range(0, globalResetTO):
                ...
                ARG = bit << 30
                # Issue command 1 with argument ARG
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "------------ Block_1_1_2_16_3b_reset_OK is completed -----------------.\n")

    def Block_1_1_2_16_3b_no_reset(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-------------- Block_1_1_2_16_3b_no_reset is started --------------.")
        last_resp = ServiceWrap.Buffer.CreateBuffer(1, 0x00)
        ...
        if (last_resp.GetTwoBytesToInt(offset = 0) != 0x000):
            raise ValidationError.TestFailError(self.fn, "Expected card in non-idle state --> instead card is in idle")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "------------ Block_1_1_2_16_3b_no_reset is completed -----------------.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC086_1_1_2_16_3b(self):
        obj = HCSPI_V2_TC086_1_1_2_16_3b(self.vtfContainer)
        obj.Run()
