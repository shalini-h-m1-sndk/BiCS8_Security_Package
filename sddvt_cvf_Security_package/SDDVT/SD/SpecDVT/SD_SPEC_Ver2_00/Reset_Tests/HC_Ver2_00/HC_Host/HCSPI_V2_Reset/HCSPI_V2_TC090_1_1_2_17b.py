...
# SCRIPTER SCRIPT                : HCSPI_V2_TC090_1_1_2_17b.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC090_1_1_2_17b.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC090_1_1_2_17b --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC090_1_1_2_17b(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            self.__dvtLib.Reset(sdcmdWrap.CARD_MODE.SD_IN_SPI, ocr=0, cardSlot=0x1, sendCmd8=True,
                                initInfo=None, rca=0x0, time=0x0, sendCMD0=0x1, bHighCapacity=True,
                                bSendCMD58=True, version=0, VOLA=globalVOLAValue,
                                cmdPattern=configPatternFiledInCMD8, reserved=0x0, sendCMD1 = True)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC090_1_1_2_17b(self):
        obj = HCSPI_V2_TC090_1_1_2_17b(self.vtfContainer)
        obj.Run()
