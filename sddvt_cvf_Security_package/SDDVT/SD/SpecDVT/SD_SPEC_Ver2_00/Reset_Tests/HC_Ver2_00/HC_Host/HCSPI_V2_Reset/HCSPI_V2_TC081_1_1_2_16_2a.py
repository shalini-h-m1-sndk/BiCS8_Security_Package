...
# SCRIPTER SCRIPT                : HCSPI_V2_TC081_1_1_2_16_2a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC081_1_1_2_16_2a.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC081_1_1_2_16_2a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC081_1_1_2_16_2a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            # Issue Cmd 1 with argument cmd1_a41arg and check the last_resp value
            ...
            # Call function Block_1_1_2_16_2a_main()
            self.Block_1_1_2_16_2a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_16_2a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "-------------- Block_1_1_2_16_2a_main is started --------------.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "------------ Block_1_1_2_16_2a_main is completed -----------------.\n")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC081_1_1_2_16_2a(self):
        obj = HCSPI_V2_TC081_1_1_2_16_2a(self.vtfContainer)
        obj.Run()
