...
# SCRIPTER SCRIPT                : HCSPI_V2_TC097_OCRvaluesInPowerCycleWithCMD0DV_A.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC097_OCRvaluesInPowerCycleWithCMD0DV_A.py
...
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC097_OCRvaluesInPowerCycleWithCMD0DV_A --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC097_OCRvaluesInPowerCycleWithCMD0DV_A(customize_log):
    ...
    def Block_main(self, cmd1_a41arg, cmd8_arg, globalProjectConfVar, loop_count):
        ...
        if ((cmd1_a41arg & 0x40000000) != 0):   # if reset passes
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Block_main is ended.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC097_OCRvaluesInPowerCycleWithCMD0DV_A(self):
        obj = HCSPI_V2_TC097_OCRvaluesInPowerCycleWithCMD0DV_A(self.vtfContainer)
        obj.Run()
