...
# SCRIPTER SCRIPT                : HCSPI_V2_TC009_1_1_2_2_2a.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSPI_V2_TC009_1_1_2_2_2a.py
# DESCRIPTION                    : Module to implement single commmand in SPI mode
# PRERQUISTE                     : HCSPI_V2_UT001_Set_SPI_Mode_To_Drivers.py, HCSPI_V2_UT004_AddressForWriteRead.py, ConfigSD_UT011_GlobalSetLSHostFreq, ConfigSD_UT006_GlobalSetVolt,HCSPI_V2_UT003_Get_last_response
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=HCSPI_V2_TC009_1_1_2_2_2a --isModel=false --enable_console_log=1 --adapter=0
...
class HCSPI_V2_TC009_1_1_2_2_2a(customize_log):
    ...
    def Run(self, globalProjectConfVar = None):
        ...
        for Loop in range(0, LoopSize):
            ...
            for loopNumber in range(0, index):
                self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Loop count is %s, Current iteration is %s" % (index, (loopNumber + 1)))
            ...
            # Call block 1_1_2_2_2a main - function Block_1_1_2_2_2a_main
            self.Block_1_1_2_2_2a_main(Yvarible, cmd1_a41arg)
    ...
    def Block_1_1_2_2_2a_main(self, Yvarible, cmd1_a41arg):
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_2a main is started ---.")
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "--- Block_1_1_2_2_2a main main is completed ---.")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSPI_V2_TC009_1_1_2_2_2a(self):
        obj = HCSPI_V2_TC009_1_1_2_2_2a(self.vtfContainer)
        obj.Run()
