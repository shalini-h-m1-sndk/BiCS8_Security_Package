...
# SCRIPTER SCRIPT                : HCSD_V2_TC008_1_1_1_10.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSD_V2_TC008_1_1_1_10.py
# DESCRIPTION                    : Test CMD8's out of sequence after Soft Reset, Power Cycle Reset, Power Cycle & CMD0 Reset.
# PRERQUISTE                     : HCSD_V2_UT01_AddressForWriteRead.py
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=HCSD_V2_TC008_1_1_1_10 --isModel=false --enable_console_log=1 --adapter=0
...
class HCSD_V2_TC008_1_1_1_10(customize_log):
    ...
    def Run(self):
        ...
        for FlagForMultipleCMD8s in range(0, 2):
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop FlagForMultipleCMD8s for 2 times. Current iteration is %s" % (FlagForMultipleCMD8s + 1))

            #***Test CMD8's out of sequence after Soft Reset***
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "***Test CMD8's out of sequence after Soft Reset***")
            ...
            if (CMDs8Flag == 0):
                ...
                for Random_CMD8_Number1_SD_HIGH in range(0, (index + 1)):
                    self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop Random_CMD8_Number1_SD_HIGH for %d times. Current iteration is %s" % ((index + 1), Random_CMD8_Number1_SD_HIGH))
            ...
            self.__sdCmdObj.ACmd41(argVal=globalOCRArgValue, computedarg=True)
            ...
            # Run cmd8, cmd55
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Run cmd8, cmd55\n")
            try:
            ...
            # Stab CMD55 - To get illegal command status for the previous command
            try:
                self.__sdCmdObj.Cmd55(setRCA=True)
            except ValidationError.CVFGenericExceptions as exc:
                self.__dvtLib.Expected_Failure_Check(exc, "CARD_ILLEGAL_CMD", "Cmd55")
            else:
            ...
            # Reset the card
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Reset the card")
            ...
            self.__dvtLib.Reset(mode=sdcmdWrap.CARD_MODE.Sd, ocr=globalOCRArgValue, cardSlot=globalCardRCA, sendCmd8=True,
                                ...
                                version=0x0, VOLA=globalVOLAValue, cmdPattern=configPatternFiledInCMD8,
            ...
            #***Test CMD8's out of sequence after Power Cycle Reset***
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "***Test CMD8's out of sequence after Power Cycle Reset***")
            index = random.randrange(0, 4) + 1
            ...
            # Run cmd0,cmd8,cmd55 , cmd41
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Run cmd0,cmd8,cmd55 , cmd41")
            ...
            if (CMDs8Flag == 0):
                ...
                for Random_CMD8_Number2_SD_HIGH in range(0, (index + 1)):   # Repeat CMD 8 random number of iterations
                    self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop Random_CMD8_Number2_SD_HIGH for %d times. Current iteration is %s" % ((index + 1), Random_CMD8_Number2_SD_HIGH))
            ...
            try:
                ...
                raise ValidationError.TestFailError(self.fn, "Expected CARD_ILLEGAL_CMD error not occured")
            ...
            #***Test CMD8's out of sequence after Power Cycle & CMD0 Reset***
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "***Test CMD8's out of sequence after Power Cycle & CMD0 Reset***")
            ...
            # Run cmd0, cmd 8, cmd55, cmd41
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Run cmd0, cmd 8, cmd55, cmd41\n")
            self.__sdCmdObj.Cmd0()
            ...
            if (CMDs8Flag == 0):
                ...
                for Random_CMD8_Number3_SD_HIGH in range(0, (index + 1)):   # Repeat CMD 8 random number of iterations
                    self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Running Loop Random_CMD8_Number3_SD_HIGH for %d times. Current iteration is %s" % ((index + 1), Random_CMD8_Number3_SD_HIGH))
            ...
            # Increment CMDs8Flag by 1
            self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Increment CMDs8Flag by 1")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSD_V2_TC008_1_1_1_10(self):
        obj = HCSD_V2_TC008_1_1_1_10(self.vtfContainer)
        obj.Run()
