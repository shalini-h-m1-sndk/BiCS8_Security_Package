...
# SCRIPTER SCRIPT                : HCSD_V2_TC001_1_1_1_1.st3
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : HCSD_V2_TC001_1_1_1_1.py
# DESCRIPTION                    : Module to To reset the card in Soft Reset, Power Cycle Reset, Power Cycle & CMD 0 Reset.
# PRERQUISTE                     : HCSD_V2_UT01_AddressForWriteRead.py
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=HCSD_V2_TC001_1_1_1_1 --isModel=false --enable_console_log=1 --adapter=0
...
class HCSD_V2_TC001_1_1_1_1(customize_log):
    ...
    def Run(self):
        ...
        # Run Cmd55 and Acmd41 till the condition ((last_resp & 0x80) == 0x0)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_HCSD_V2_TC001_1_1_1_1(self):
        obj = HCSD_V2_TC001_1_1_1_1(self.vtfContainer)
        obj.Run()
