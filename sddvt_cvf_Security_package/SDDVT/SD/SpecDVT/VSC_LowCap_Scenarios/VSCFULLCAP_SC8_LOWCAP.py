...
# CTF SCRIPT                     : VSCFULLCAPSC8_Validation.py
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : VSCFULLCAP_SC8_LOWCAP.py
...
# TEST ARGUMENTS                 : --test=VSCFULLCAP_SC8_LOWCAP --isModel=false --enable_console_log=1 --adapter=0
...
class VSCFULLCAP_SC8_LOWCAP(customize_log):
    ...
    def Measure_Pw(self):
        ...
        for loop_count in range(self.__total_AUs): # all AUs to be checked for Pw
            ...
            if (loop_count < (self.__total_AUs-1)):
                ...
                self.__sdCmdObj.Cmd20(Argument)
                time.sleep(0.250)        #250ms delay
                if ( self.__AUCOUNT % 16 == 0 ) : #change CI address every 16AUs
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_VSCFULLCAP_SC8_LOWCAP(self):
        obj = VSCFULLCAP_SC8_LOWCAP(self.vtfContainer)
        obj.Run()
