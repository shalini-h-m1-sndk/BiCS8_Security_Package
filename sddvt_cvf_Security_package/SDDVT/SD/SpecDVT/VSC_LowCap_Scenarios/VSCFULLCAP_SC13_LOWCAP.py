...
# CTF SCRIPT                     : VSCFULLCAPSC13_Validation.py
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : VSCFULLCAP_SC13_LOWCAP.py
...
# TEST ARGUMENTS                 : --test=VSCFULLCAP_SC13_LOWCAP --isModel=false --enable_console_log=1 --adapter=0
...
class VSCFULLCAP_SC13_LOWCAP(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_VSCFULLCAP_SC13_LOWCAP(self):
        obj = VSCFULLCAP_SC13_LOWCAP(self.vtfContainer)
        obj.Run()
