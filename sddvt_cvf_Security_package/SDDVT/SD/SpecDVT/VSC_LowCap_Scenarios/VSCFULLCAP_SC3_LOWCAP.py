...
# CTF SCRIPT                     : VSCFULLCAPSC3_Validation.py
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : VSCFULLCAP_SC3_LOWCAP.py
...
# TEST ARGUMENTS                 : --test=VSCFULLCAP_SC3_LOWCAP --isModel=false --enable_console_log=1 --adapter=0
...
class VSCFULLCAP_SC3_LOWCAP(customize_log):
    ...
    def Measure_Pw(self):
        ...
        for loop_count in range(self.__total_AUs): # all AUs to be checked for Pw
            ...
            for i in range(self.__RUinAU):
                ...
                performance = old_div((float(perfValue.perfReadWrite.perfResults)), (1000 * 1000))  # converting performance to MB/
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_VSCFULLCAP_SC3_LOWCAP(self):
        obj = VSCFULLCAP_SC3_LOWCAP(self.vtfContainer)
        obj.Run()
