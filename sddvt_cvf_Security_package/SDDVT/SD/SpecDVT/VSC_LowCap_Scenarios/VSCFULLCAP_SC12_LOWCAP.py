...
# CTF SCRIPT                     : VSCFULLCAPSC12_Validation.py
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : VSCFULLCAP_SC12_LOWCAP.py
...
# TEST ARGUMENTS                 : --test=VSCFULLCAP_SC12_LOWCAP --isModel=false --enable_console_log=1 --adapter=0
...
class VSCFULLCAP_SC12_LOWCAP(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_VSCFULLCAP_SC12_LOWCAP(self):
        obj = VSCFULLCAP_SC12_LOWCAP(self.vtfContainer)
        obj.Run()
