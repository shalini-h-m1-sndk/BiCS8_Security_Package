...
# CTF SCRIPT                     : VSCFULLCAPSC4_Validation.py
# CVF CALL ALL SCRIPT            : None
# CVF SCRIPT                     : VSCFULLCAP_SC4_LOWCAP.py
...
# TEST ARGUMENTS                 : --test=VSCFULLCAP_SC4_LOWCAP --isModel=false --enable_console_log=1 --adapter=0
...
class VSCFULLCAP_SC4_LOWCAP(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_VSCFULLCAP_SC4_LOWCAP(self):
        obj = VSCFULLCAP_SC4_LOWCAP(self.vtfContainer)
        obj.Run()
