...
# CVF SCRIPT                     : TC04_CounterCheck_PRMA_Unlock.py
# DESCRIPTION                    : Verify counter of nonce during GDC command for PRMA unlock
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC04_CounterCheck_PRMA_Unlock.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Shalini HM
# REVIEWED BY                    : None
# DATE                           : 07-Nov-2024
################################################################################
...
class TC04_CounterCheck_PRMA_Unlock(customize_log):
    ...
    def Run(self):
        ...
        Challenge1=self.RMAutils.GetDeviceChallenge(rma='PRMA', signed=True)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC04_CounterCheck_PRMA_Unlock(self):
        obj = TC04_CounterCheck_PRMA_Unlock(self.vtfContainer)
        obj.Run()
