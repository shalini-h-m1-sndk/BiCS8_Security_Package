...
class TC019_PRMA_Unlock_With_DPDM(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC019_PRMA_Unlock_With_DPDM(self):
        obj = TC019_PRMA_Unlock_With_DPDM(self.vtfContainer)
        obj.Run()
