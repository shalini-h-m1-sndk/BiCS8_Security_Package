...
# CVF SCRIPT                     : TC010_LRMA_Unlock_With_DPDM.py
# DESCRIPTION                    : Performs LRMA Unlock With 1 Sec DPDM.
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC010_LRMA_Unlock_With_DPDM.py --isModel=false --enable_console_log=1 --adapter=0
...
class TC010_LRMA_Unlock_With_DPDM(customize_log):
    ...
    def Run(self):
        ...
        # 4 sec delay for DPDM
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name,  "Issued 1 sec timeout to check DPDM")
        time.sleep(1)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC010_LRMA_Unlock_With_DPDM(self):
        obj = TC010_LRMA_Unlock_With_DPDM(self.vtfContainer)
        obj.Run()
