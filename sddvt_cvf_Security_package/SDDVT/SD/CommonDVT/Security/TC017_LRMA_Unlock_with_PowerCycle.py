...
# CVF SCRIPT                     : TC017_LRMA_Unlock_with_PowerCycle.py
# DESCRIPTION                    : Performs LRMA Unlock after power cycle without issuing GDC again.
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC017_LRMA_Unlock_with_PowerCycle.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Shalini HM
# REVIEWED BY                    : None
# DATE                           : 14-Nov-2024
################################################################################
...
class TC017_LRMA_Unlock_with_PowerCycle(customize_log):
    ...
    def Run(self):
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "GDC for LRMA")
        ...
        # Unlock command
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Issue LRMA Unlock after Power cycle")
        try:
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC017_LRMA_Unlock_with_PowerCycle(self):
        obj = TC017_LRMA_Unlock_with_PowerCycle(self.vtfContainer)
        obj.Run()
