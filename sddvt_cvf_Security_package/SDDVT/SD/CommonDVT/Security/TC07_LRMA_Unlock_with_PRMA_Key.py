...
# CVF SCRIPT                     : TC07_LRMA_Unlock_with_PRMA_Key.py
# DESCRIPTION                    : Performs LRMA Unlock with PRMA key
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC07_LRMA_Unlock_with_PRMA_Key.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Punith Kumar P
# REVIEWED BY                    : None
# DATE                           : 07-Nov-2024
################################################################################
"""
...
class TC07_LRMA_Unlock_with_PRMA_Key(customize_log):
    ...
    def Run(self):
        ...
        # LRMA Unlock with PRMA Key
        
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name,  "LRMA Unlock with PRMA key")
        try:
            status = self.RMAutils.UnlockCard("LRMA", self.__Challenge, UnlockKey = 'PRMA')
            if status != 0:
        ...
        #  issue GDC to check card is in lock status afer Unlock cmd
        try:
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC07_LRMA_Unlock_with_PRMA_Key(self):
        obj = TC07_LRMA_Unlock_with_PRMA_Key(self.vtfContainer)
        obj.Run()
