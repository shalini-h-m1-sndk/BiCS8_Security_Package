...
class TC015_PRMA_Unlock_with_LRMA_GDC(customize_log):
        ...
        try:
            ...
            if status != 0:
                    ...
                    if ErrorCodes == "0x6000205":                
                        ...
                        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "PRMA Unlock unsuccessfull as expected,with the LRMA GDC")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC015_PRMA_Unlock_with_LRMA_GDC(self):
        obj = TC015_PRMA_Unlock_with_LRMA_GDC(self.vtfContainer)
        obj.Run()
