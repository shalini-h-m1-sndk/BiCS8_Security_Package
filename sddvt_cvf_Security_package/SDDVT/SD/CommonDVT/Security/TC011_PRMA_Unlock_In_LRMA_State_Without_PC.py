...
# CVF SCRIPT                     : TC011_PRMA_Unlock_In_LRMA_State_Without_PC.py
# DESCRIPTION                    : Performs PRMA Unlock in LRMA State without Power cycle.
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC011_PRMA_Unlock_In_LRMA_State_Without_PC.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Shalini HM
# REVIEWED BY                    : None
# DATE                           : 07-Nov-2024
################################################################################
...
class TC011_PRMA_Unlock_In_LRMA_State_Without_PC(customize_log):
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC011_PRMA_Unlock_In_LRMA_State_Without_PC(self):
        obj = TC011_PRMA_Unlock_In_LRMA_State_Without_PC(self.vtfContainer)
        obj.Run()
