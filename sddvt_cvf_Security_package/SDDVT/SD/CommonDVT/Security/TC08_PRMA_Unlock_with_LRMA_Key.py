...
# CVF SCRIPT                     : TC08_PRMA_Unlock_with_LRMA_Key.py
# DESCRIPTION                    : Performs PRMA Unlock with LRMA Key.
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC08_PRMA_Unlock_with_LRMA_Key.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Shalini HM
# REVIEWED BY                    : None
# DATE                           : 03-dec-2024
################################################################################
...
class TC08_PRMA_Unlock_with_LRMA_Key(customize_log):
    ...
    def Run(self):
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name,  "PRMA Unlock with LRMA key")
        
        try:
            status = self.RMAutils.UnlockCard("PRMA", self.__Challenge, UnlockKey = 'LRMA')
            if status != 0:
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC08_PRMA_Unlock_with_LRMA_Key(self):
        obj = TC08_PRMA_Unlock_with_LRMA_Key(self.vtfContainer)
        obj.Run()
