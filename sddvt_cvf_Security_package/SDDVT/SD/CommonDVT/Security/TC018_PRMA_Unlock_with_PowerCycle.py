...
# CVF SCRIPT                     : TC018_PRMA_Unlock_with_PowerCycle.py
# DESCRIPTION                    : Performs PRMA Unlock after power cycle without issuing GDC again.
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC018_PRMA_Unlock_with_PowerCycle.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Shalini HM
# REVIEWED BY                    : None
# DATE                           : 13-Dec-2024
################################################################################
...
class TC018_PRMA_Unlock_with_PowerCycle(customize_log):
    ...
    def Run(self):
        ...
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "GDC for PRMA")
        ...
        # Unlock command
        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "Issue PRMA Unlock after Power cycle")
        try:
            ...
            if status != 0:
                    ...
                    if ErrorCodes == "0x6000205":                
                        ...
                        self.infoLog(self.fn, currentframe().f_lineno, sys._getframe().f_code.co_name, "LRMA Unlock unsuccessfull as expected,since issuing power cycle before unlock")
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC018_PRMA_Unlock_with_PowerCycle(self):
        obj = TC018_PRMA_Unlock_with_PowerCycle(self.vtfContainer)
        obj.Run()
