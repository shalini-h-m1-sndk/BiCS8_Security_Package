...
# CVF SCRIPT                     : TC03_CounterCheck_LRMA_Unlock.py
# DESCRIPTION                    : Verify counter of nonce during GDC command for LRMA unlock.
# PRERQUISTE                     :
# STANDALONE EXECUTION           : Yes
# TEST ARGUMENTS                 : --test=TC03_CounterCheck_LRMA_Unlock.py --isModel=false --enable_console_log=1 --adapter=0
# AUTHOR                         : Shalini HM
# REVIEWED BY                    : None
# DATE                           : 06-Nov-2024
################################################################################
...
class TC03_CounterCheck_LRMA_Unlock(customize_log):
    ...
    def Run(self):
        ...
        # Get Device challenge for LRMA Unlock
        Challenge2=self.RMAutils.GetDeviceChallenge(rma='LRMA', signed=True)
...
class MainClass(TestCase.TestCase, customize_log):
    ...
    def test_TC03_CounterCheck_LRMA_Unlock(self):
        obj = TC03_CounterCheck_LRMA_Unlock(self.vtfContainer)
        obj.Run()
